        ...
        <View style={styles.container}>
          ...
          <View>
            ...
            <TextInput
              ...
              underlineColorAndroid='transparent'
            />
            {props.touched.email && props.errors.email && <Text style={styles.errorText}>{props.errors.email}</Text> }

            <TextInput
              style={{...styles.input, backgroundColor: props.touched.username && props.errors.username ? 'red' : 'white'}}
            ...
            {props.touched.username && props.errors.username && <Text style={styles.errorText}>{props.errors.username}</Text>}

            <TextInput
              style={{...styles.input, backgroundColor: props.touched.password && props.errors.password ? 'red' : 'white'}}
            ...
            {props.touched.password && props.errors.password && <Text style={styles.errorText}>{props.touched.password && props.errors.password}</Text>}

            <TextInput
              style={{...styles.input, backgroundColor: props.touched.confirm_password && props.errors.confirm_password ? 'red' : 'white'}}
